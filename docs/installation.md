...
To enable support for the **Valkey** cache backend (a high-performance cache system), install the optional dependency:
...
**Requirements:**
- Python 3.10 or higher (Valkey requires Python 3.10+)
...
If you're using Python 3.9 or don't need Valkey support, the base installation (`pip install dj-cache-panel`) works perfectly fine.
